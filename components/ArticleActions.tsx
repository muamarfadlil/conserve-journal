    ...
    <div className="space-y-4">
      <div className="flex flex-col sm:flex-row gap-3">
        {article.pdfUrl ? (
          ...
          <span className="flex-1 flex items-center justify-center py-3 px-6 rounded-xl cursor-not-allowed
        ...
        <button
          ...
          className="flex items-center justify-center gap-2 py-3 px-5 rounded-xl text-sm transition-all duration-200
      ...
      {article.doi && (
        <button
          ...
          className="inline-flex items-center gap-2 text-xs text-[var(--text-muted)] hover:text-gold-500 dark:hover:text-gold-400 transition-colors duration-200"
        >
